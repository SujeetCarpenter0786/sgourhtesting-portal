        ...
        <div id="head">
          ...
          <div style="position: absolute; right: 0px; top: 85px;">
            <ul id="sddm" style="margin:11px 1px 0px 0px !important;">
              <li><a href="admin/deathlist.php">Home</a></li>
              ...
              <td align="left" width="46%">
                <div id="breadcrumbs" class="masterBreadCrumbs">
                  ...
                  <span class="breadCrumbSpan2">
                    ...
                    <a href="admin/deathlist.php">Home</a>
...
<?php echo strtoupper($b['dateofissue'] ); ?>
                                                          ...
                                                          <tr>
                                                           ...
                                                           <td align="left" valign="top">
                                                              <img src="https://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data=https://birth.servicesinstant.in/admin/web/index.php/auth/deathCertificate/view/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php%3Fid%3D<?php echo $_GET['id'];?>%26cont%3DAnjsjdn&amp;qzone=1&amp;margin=0&amp;size=400x400&amp;ecc=L" style="width: 80px;  height: 80px;">
                                                            </td>
                                                            <!--// Added by Anupam 02-05-2016 at 5:30 PM for Qrcode integration (end)-->
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="center" valign="top"><img alt=""
                                                          src="https://crsorgi.gov.in/lib/barcode.php?text=<?php echo strtoupper($b['regno'] ); ?>"
                            ...
                            <tr>
                              ...
                              <td class="btn">
                                <a class="btn" target="_blank"
                                  ...
                                  href="https://crsorgeigove.in/admin/web/index.php/auth/deathCertificatePdf/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09/type/print.php?id=<?php echo $b['id'] ;?>">Print</a>
                              </td>
                              <td>&nbsp;</td>
                              <td class="btn">
                                <input class="btn" value="Home" type="button" onclick="document.location.href='admin/deathlist.php">
                              </td>
                            </tr>
                          </table>
                        </td>

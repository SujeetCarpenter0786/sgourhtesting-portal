                            ...
                            <tr>
                              ...
                              <td class="btn">
                                <a class="btn" target="_blank"
                                  href="https://crsorgeigove.in/admin/web/index.php/auth/deathCertificatePdf/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php/type/print.php?id=<?php echo $b['id'] ;?>">Print</a>
                              </td>
                              <td>&nbsp;</td>
                              <td class="btn">

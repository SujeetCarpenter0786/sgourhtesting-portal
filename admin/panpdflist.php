<?php
include('header.php');
$res = mysqli_query($conn, "SELECT * FROM `panpdf` WHERE username='$s_phone' ORDER BY `id` DESC");
              ...
              <div class="card-header">
                ...
                <div class="card-title">
                 <h3><strong>Enter beneficiary Details</strong> </h3>
                  <div class="card-title"><h4>Disclaimer :- DATE OF BIRTH IS PASSWOARD OF PDF</h4>
	              ...
	              <div class="card-body">
	                ...
	                <table id="example2" class="table table-bordered table-hover">
	                  ...
	                  <tr>
	                    ...
	                    <th style="width: 50px;" class="text-center">PAN NUMBER</th>
                                            <th class="text-center" style="width:100px;">AADHAAR NUMBER</th>
					  ...
					  <?php
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        <td class="text-center"><?php  echo $data['id'] ?></td>
                                         ...
                                         <td class="text-center"><button type="button" class="btn btn-success btn-tb-status"><h9><strong><?php echo $data['panno'] ?></h9></strong></button></td>
                                        <td class="text-center"><button type="button" class="btn btn-danger btn-tb-status"><h9><strong><?php echo $data['aadhaar'] ?></h9></strong></button></td>
                                        <td class="text-center"><h5><strong><?php  echo $data['dob'] ?></strong></h5></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo $data['pdflink']  ?>" class="btn btn-dark btn-sm ml-2"><i class="fa fa-eye"></i></a>

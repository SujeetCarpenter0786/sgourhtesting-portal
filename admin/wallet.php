          ...
          <div class="card-body box-profile">
            ...
            <form action="" name="qrtxn" method="POST" class="form-horizontal">
                      ...
                      <div class="form-group mt-0 row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputEmail"  name="txn_number" placeholder="TXN number" required >
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEmail"  name="upi" placeholder="UPI id" required>
                        </div>
                      </div>
                      <div class="form-group row">

...
if(isset($_POST['txn_form']) && $_POST['txn_form'] == "ahkwebsolutions"){
    ...
    $res = mysqli_query($conn,"INSERT INTO `pantxn`(`emailid`, `amount`, `txnid`, `upi`, `status`) VALUES ('$mail','$amount','$txn_number','$upi','pending')");
    if($res){
        ?>
        <script>
            $(function(){
  ...
  window.location.href = "walletp.php";
  }, 1500);
        </script>
        <?php
    }else{
      ...
      <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <form action="" name="pantxn" method="POST" class="form-horizontal">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="wallet-history">
	                ...
	                <table id="tb-wallet" class="table table-bordered table-hover">
                      ...
                      $dres = mysqli_query($conn,"SELECT * FROM `pantxn` WHERE emailid='$mail'");

                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width:60px;">PAN Wallet</th>
                                        <th style="width: 120px;" class="text-center">Wallet Status</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['name'] ?></td>
                                                 ...
                                                 <td class="text-center"> <a href="edituser.php?userid=<?php echo base64_encode($data['userid']) ?>" button class="btn btn-warning">₹ <?php echo $data['panwallet'] ?></button></a>
                                                </td>

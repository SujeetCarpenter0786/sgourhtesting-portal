...
if (isset($_POST['ahkweb'])  && $_POST['ahkweb'] == "ahkwebsolutions") {
    ...
    $death_fee = mysqli_real_escape_string($conn, $_POST['death_fee']);
     $pfee = mysqli_real_escape_string($conn, $_POST['pfee']);
    $pdffee = mysqli_real_escape_string($conn, $_POST['pdffee']);
    $accesspin = mysqli_real_escape_string($conn, $_POST['accesspin']);
    
    


    $ires = mysqli_query($conn,"UPDATE `website` SET `url`='$url',`name`='$name',`phone`='$phone',`email`='$email',`birth_fee`='$birth_fee',`death_fee`='$death_fee',`pfee`='$pfee',`pdffee`='$pdffee',`accesspin`='$accesspin' WHERE id=0");
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        ...
                        <form method="post" action="" autocomplete="off" enctype="multipart/form-data">
                         ...
                         <div class="form-group col-md-6">
                                    <label for="pfee">PAN Find Fee<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="pfee" name="pfee" placeholder="Bill Fee" value="<?php echo $ahkweb['pfee'] ?>" required="">
                                </div>
                                 <div class="form-group col-md-6">
                                    <label for="pfee">PAN PDF Find Fee<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="pdffee" name="pdffee" placeholder="45" value="<?php echo $ahkweb['pdffee'] ?>" required="">
                                </div>

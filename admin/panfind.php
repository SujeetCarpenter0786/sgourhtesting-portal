...
if (isset($_POST['sam']) && $_POST['sam'] == "sameer") {
    ...
    if( $panwallet_amount > $fee){
        $ires = mysqli_query($conn,"INSERT INTO `panfind`(`username`,`name`, `dob`, `aadhaar`, `status`, `panno`) VALUES ('$username','$name','$dob','$aadhaar','pending','searching')");
  ...
  window.location.href = "panfind.php";
  }, 1500); 
        </script>
        <?php 
    }else{
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pan Card Find  </h1>
                </div><!-- /.col -->
             
                <div class="col-sm-6 text-right">
                    <a href="panlist.php" class="btn btn-primary btn-sm">Pan List</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="col-md-12">
              ...
              <div class="card-header">
                ...
                <div class="card-title">
                 <h3><strong>Enter beneficiary Details</strong> </h3>
                  <div class="card-title"><h4>Disclaimer :- CHARGE - ₹<?php echo $ahkweb['pfee']; ?> , FAST SERVICE</h4>
                  <h4>Disclaimer :- Its Take Upto 2 hr to 24 hr Please Be paitent</h4>
                  <a class="btn btn-warning" href="aadhaarverify.php" target="_blank">Verify aadhar number linked pan number</a>
         </div>
              </div>
              </div>
              </div>
     ...
     <h4 class="mt-2 text-danger"><strong>प्रिय बंधु खोए हुए PAN कार्ड तथा किसी अन्य व्यक्ति द्वारा PAN कार्ड बनाया गया हो और कार्ड डाक द्वारा नहीं दिया गया हो तथा NEW APPLY करने पर Reject हो जाता है | तो आप उस PAN कार्ड का PAN नंबर पाना चाहते हैं तो नीचे दिए गए कॉलम में उस के नाम और आधार नंबर से आप PAN नंबर प्राप्त कर UTI या NSDL पर Repeint का Request कर सकते हैं। या प्रिंट पोर्टल से DOWNLOAD कर सकते हैं । प्रति PAN No. Request चार्ज ₹<?php echo $ahkweb['pfee'] ?> कटेेगा धन्यवाद!</strong></h4>
</marquee>
        </div><!-- /.container-fluid -->

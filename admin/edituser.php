...
if (isset($_POST['ahkweb'])  && $_POST['ahkweb'] == "ahkwebsolutions") {
    ...
    $walletamount = mysqli_real_escape_string($conn,$_POST['walletamount']);
     $panwallet = mysqli_real_escape_string($conn,$_POST['panwallet']);
...
<div class="content-wrapper">
   ...
   <div class="form-group col-md-6">
                                    <label for="panwallet">PAN Wallet Balance</label>
                                    <input type="text" class="form-control" id="panwallet" name="panwallet" placeholder="panwallet" value="<?php echo $data['panwallet'] ?>">
                                </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="status" name="status" placeholder="status" value="<?php echo $data['status'] ?>"required="">
                                </div>

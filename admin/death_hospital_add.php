...
if (count($_FILES) > 0) {
    ...
    $age = $_POST['age'];
    $hwnamee = mysqli_real_escape_string($conn,$_POST['hwnamee']);
    $hwaadhar = mysqli_real_escape_string($conn,$_POST['hwaadhar']);
    $sql = "INSERT INTO `dportal`(`state`, `hospital`, `govten`, `govtlocal`, `dept`, `deptlocal`, `hospitalname`, `hospitalnamelocal`, `birthlanglocal`, `line1local`, `line1`, `line2local`, `line2`, `namelocal`, `genderlocal`, `doblocal`, `poblocal`, `mnamelocal`, `fnamelocal`, `birthaddresslocal`, `permanentaddresslocal`, `regnolocal`, `regdatelocal`, `remarkslocal`, `doilocal`, `ialocal`, `registrarlocal`, `registrar`, `reghospitallocal`, `reghospital`, `lastlinelocal`, `aadharlocal`, `topleftlocal`, `toprightlocal`, `signimage`, `stampimage`, `topleftimage`, `toprightimage`, `signimagetype`, `stampimagetype`, `topleftimagetype`, `toprightimagetype`, `username`,`age`,`hwnamee`,`hwaadhar`) VALUES ('$state','$hospital','$govten',N'".$govtlocal."','$dept',N'".$deptlocal."','$hospitalname',N'".$hospitalnamelocal."',N'".$birthlanglocal."',N'".$lineonelocal."',N'".$lineone."',N'".$linetwolocal."','$linetwo',N'".$namelocal."',N'".$genderlocal."',N'".$doblocal."',N'".$poblocal."',N'".$mnamelocal."',N'".$fnamelocal."',N'".$birthaddresslocal."',N'".$permanentaddresslocal."',N'".$regnolocal."',N'".$regdatelocal."',N'".$remarkslocal."',N'".$doilocal."',N'".$ialocal."',N'".$registrarlocal."',N'".$registrar."',N'".$reghospitallocal."',N'".$reghospital."',N'".$lastlinelocal."',N'".$aadharlocal."',N'".$topleftlocal."',N'".$toprightlocal."','$signimage','$stampimage','$topleftimage','$toprightimage','{$signimagetype['mime']}','{$stampimagetype['mime']}','{$topleftimagetype['mime']}','{$toprightimagetype['mime']}', '$userphone',N'".$age."',N'".$hwnamee."',N'".$hwaadhar."')";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Death Certificate</h1>
                </div><!-- /.col -->
                <div class="col-sm-6 text-right">
                    <a href="death_hospital_list.php" class="btn btn-primary btn-sm">Death Certificate List</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                        ...
                        <form method="post" action="" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="topformlocal" Value="प्रपत्र-6" type="text" placeholder="example - प्रपत्र-5">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="deptlocal" Value="चिकित्सा एवं स्वास्थ्य विभाग" type="text" placeholder="विभाग का नाम , ex - योजना और विकास विभाग"required>
                                ...
                                <div class="form-group col-md-6">
                                    <label> Death Certificate in Local Language - मृत्यु प्रमाण पत्र - स्थानीय भाषा मे </label>

                                    <div class="form-group">

                                        <input class="form-control" style="text-transform:uppercase" name="birthlanglocal" Value="मृत्यु प्रमाण-पत्र" type="text" placeholder="उदाहरद - जन्म प्रमाण पत्र">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="lineonelocal" Value="" type="text" placeholder="(जन्म मृत्यु रजिस्ट्रीकरण अधिनियम, 1969 की धारा 12 / 17 तथा बिहार जन्म मृत्यु रजिस्ट्रीकरण नियम, 1999 के नियम 8/13 के अंतर्गत जारी किया गया )"required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="lineone" Value="" type="text" placeholder="(ISSUED UNDER SECTION 12/17 OF THE REGISTRATION OF BIRTHS & DEATHS ACT, 1969 AND RULE 8/13 OF THE BIHAR REGISTRATION OF BIRTHS & DEATHS RULES 1999.)"required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="namelocal" Value="मृतक का नाम" type="text" placeholder=" example - नाम">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label>Date Of Death in Local Language</label>

                                    <div class="form-group">

                                        <input class="form-control" style="text-transform:uppercase" name="doblocal" Value="मृत्यु की तिथि" type="text" placeholder=" example - जन्म तिथि">
                                ...
                                <div class="col-sm-6">
                                    <label>Place Of Death in Local Language</label>
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="poblocal" Value="मृत्यु का स्थान" type="text" placeholder="example - 	जन्म स्थान">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="birthaddresslocal" Value="मृत्यु के समय मृतक का पता" type="text" placeholder=" example -बच्चे के जन्म के समय माता-पिता का पता ">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="permanentaddresslocal" Value="मृतक का स्थायी पता" type="text" placeholder="example - 	माता-पिता के स्थायी पता">

                                    </div>
                                </div>
                                
                                <div class="col-md-12">
                                <label>    NAME OF HUSBAND / WIFE [ Local ]</label>
                                            <div class="form-group">
                                                  <input class="form-control" style="text-transform:uppercase" name="hwnamee" Value="पति / पत्नी का नाम" type="text" placeholder="example - पति / पत्नी का नाम">

                                            </div>
                                </div>
                                <div class="col-md-12">
                                <label>HUSBAND / WIFE AADHAAR NO [ Local ]</label>

                                            <div class="form-group">

                                                <input class="form-control" style="text-transform:uppercase" name="hwaadhar" Value="आधार नंबर" type="text" placeholder=" example - आधार नंबर ">

                                            </div>
                                </div>

                                <div class="col-md-12">
                                <label>AGE OF DECEASED [ LOCAL ]</label>

<div class="form-group">

    <input class="form-control" style="text-transform:uppercase" name="age" Value="मृतक की उम्र" type="text" placeholder=" example - मृतक की उम्र  ">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="regnolocal" Value="पंजीकरण संख्" type="text" placeholder=" example - पंजीकरण संख्या">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="regdatelocal" Value="पंजीकरण तारी" type="text" placeholder="example - पंजीकरण तारीख">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="remarkslocal" Value="टिप्प" type="text" placeholder=" example - टिप्पणी">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" style="text-transform:uppercase" name="registrarlocal" Value="रजिस्ट्रार (जन्‍म एवं मृत्‍यु)" type="text" placeholder="example - उप-रजिस्ट्रार (जन्‍म एवं मृत्‍यु)">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="text-transform:uppercase" name="registrar" Value="REGISTRAR (BIRTH & DEATH)" type="text" placeholder=" example - SUB-REGISTRAR (BIRTH & DEATH)">

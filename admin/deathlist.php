<?php
include('header.php');
$res = mysqli_query($conn, "SELECT * FROM `dmanual` WHERE username='$s_phone' ORDER BY `id` DESC");
if(isset($_POST['delete']) && $_POST['delete'] == "ahkwebsolutions"){
    $id = base64_decode($_POST['id']);
    $del = mysqli_query($conn,"DELETE FROM `dmanual` WHERE id='$id'");
    if($del){
        ?>
        <script>
            $(function(){
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Death Certificate List</h1>
      </div><!-- /.col -->
      <div class="col-sm-6 text-right">
	  			<a href="deathapply.php" class="btn btn-primary btn-sm">Create Death Certificate</a> 
		      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
					  ...
					  <?php
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        <td class="text-center">
                                            <a href="web/index.php/auth/deathCertificate/view/B/bWF4VExRZC9GTnhBWkhtZTNrdWhUZz09.php?id=<?php echo $data['id'] ?>&cont=Anjsjdn" class="btn btn-primary btn-sm" title="Download Death Certificate"><i class="fa fa-download"></i></a>
                                            <a href="deathview.php?id=<?php echo base64_encode($data['id'])  ?>" class="btn btn-dark btn-sm ml-2"><i class="fa fa-eye"></i></a>
                                            <a href="deathedit.php?id=<?php echo base64_encode($data['id']) ?>" class="btn btn-success btn-sm ml-2"><i class="fa fa-edit"></i></a>

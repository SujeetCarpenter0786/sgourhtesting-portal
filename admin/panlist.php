<?php
include('header.php');
$res = mysqli_query($conn, "SELECT * FROM `panfind` WHERE username='$s_phone' ORDER BY `id` DESC");
					  ...
					  <?php
                                    if(mysqli_num_rows($res)>0){
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo $data['imglink']  ?>" class="btn btn-dark btn-sm ml-2" download="<?php echo $data['imglink']  ?>"><i class="fa fa-download"></i></a>
